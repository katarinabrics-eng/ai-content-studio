    ...
    <div className="pvi-page">
      ...
      <section className="deliverables" style={{background:"#fafaf7", padding:"80px 0"}}>
        ...
        <div className="codostanete-columns" style={{display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:"10px", padding:"0 10px"}}>
          {[
            {src:"/placeholders/CO DOSTANETE/vizual-board-vyber.jpg", pill:"Vizuální board", title:"Výběr vašeho stylu", sub:"Ještě před focením víte přesně jak budete vypadat", desc:"Ještě před focením uvidíte přesně jak budete vypadat. Outfity, prostředí, nálada, kompozice — vše promyšlené dopředu. Na focení přijdete připravená. Žádná improvizace, žádná nejistota."},
            {src:"/placeholders/CO DOSTANETE/brand-dna.jpg", pill:"Brand DNA", title:"Archetyp · tón · strategie", sub:"Průvodce pro obsah a komunikaci", desc:"Strategický dokument který popisuje kdo jste, jak komunikujete a pro koho tvoříte. Váš archetyp, tón hlasu, klíčová témata. Základ pro veškerý obsah — fotky, texty, sítě."},
            {src:"/placeholders/CO DOSTANETE/reels.jpg", pill:"Reels · video", title:"Video záběry s hookem", sub:"Střihový brief · 15s formát", desc:"Krátké autentické videozáběry připravené k publikaci. Teplý grading dle vašeho vizuálního stylu. Hotové pro Instagram, LinkedIn i Stories — stačí zveřejnit."},
            {src:"/placeholders/CO DOSTANETE/vizual-board.jpg", pill:"Vizuální board", title:"Contact sheet s vaší podobou", sub:"Outfit plán · nálada · prostředí", desc:"Kontaktní sheet vašich fotografií roztříděný dle scény, nálady a záběru. Vždy víte co máte k dispozici a pro jaký příspěvek to použít."},
            {src:"/placeholders/CO DOSTANETE/canva-sablony.jpg", pill:"Canva šablony", title:"10 šablon na míru", sub:"Vaše barvy · fonty · ikony", desc:"Deset grafických šablon nastavených přesně na váš brand — vaše barvy, fonty, styl. Otevřete v Canva, upravíte text a máte hotový příspěvek za minutu."},
            {src:"/placeholders/CO DOSTANETE/strategie.jpg", pill:"Strategie", title:"Komunikační rámec", sub:"Témata · plán obsahu · scénáře", desc:"Měsíční obsahový cyklus s tématy pro každý týden. Nikdy nebudete stát nad prázdnou stránkou a přemýšlet co zveřejnit. Každý příspěvek má jasný záměr."},
            {src:"/placeholders/CO DOSTANETE/prispevky.jpg", pill:"Příspěvky na sítě", title:"Obsah připravený k použití", sub:"Instagram · LinkedIn · Facebook", desc:"Konkrétní návrhy příspěvků — témata, hooky, texty. Víte přesně co publikovat, kde a kdy. Obsah který přitahuje správné klienty, ne jen lajky."},
            {src:"/placeholders/CO DOSTANETE/vizualni-banka.jpg", pill:"Vizuální banka", title:"Knihovna vašich fotek", sub:"Tříděno dle scény a nálady", desc:"Roztříděná knihovna vašich fotografií dle scény, nálady a záběru. Vždy víte kde hledat správnou fotku pro každý příspěvek. ✦ Přístup do stocku fotografií je součástí Content Day."},
          ].map((item, i) => (
