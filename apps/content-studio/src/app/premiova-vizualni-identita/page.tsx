    ...
    <main className="min-h-screen bg-stone-50">
        ...
        <div className="relative mx-auto max-w-[1360px] px-6 xl:px-10">
          <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="flex flex-col justify-center lg:col-span-5">
              ...
              <a href="/start" className="mt-8 inline-block text-[17px] font-medium text-[#111111] underline underline-offset-4 hover:no-underline">
      ...
      <section id="struktura-spoluprace" className="w-full bg-[#F7F8F5] py-[140px]">
        <div className="mx-auto max-w-[1360px] px-6 xl:px-10">
          ...
          <a href="/start" className="mt-8 inline-block rounded-lg bg-[#A8EB12] px-8 py-3.5 text-base font-semibold text-zinc-900 hover:bg-[#A8EB12]/90">
            Domluvit strategickou konzultaci
          </a>
        </div>
      </section>
