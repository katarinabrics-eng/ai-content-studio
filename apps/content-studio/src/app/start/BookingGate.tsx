...
type TabId = "premiova" | "portret" | "rodinne";
...
export function BookingGate() {
  ...
  useEffect(() => {
    ...
    if (f && ["premiova", "portret", "rodinne"].includes(f)) setActiveTab(f);
  }, [searchParams]);
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          <div style={{ maxWidth: 560, margin: "0 auto", padding: "20px 24px", background: "#FFFFFF", borderRadius: 16, boxShadow: "0 4px 20px rgba(0,0,0,0.04)", border: "1px solid #EAEAE7", textAlign: "left" }}>
            ...
            <p style={{ fontSize: 15, color: "#1A1A1A", lineHeight: 1.6, marginBottom: 12 }}>
              Na této stránce zvolíte typ spolupráce, vyplníte základní údaje a podle typu služby buď domluvíte konzultaci zdarma, nebo (u prémiové vizuální identity s placeným boardem) nejdříve analyzujeme váš web a připravíme vizuální směr. Po dokončení kroku vás provedeme k výběru termínu a zahájení spolupráce.
            </p>
            ...
            <p style={{ fontSize: 15, color: "#1A1A1A", lineHeight: 1.6 }}>
              U prémiové identity (placená varianta) URL vašeho webu. U ostatních služeb stačí vyplnit krátký formulář a zvolit termín. Platbu řešíme až po domluvě.
            </p>
          </div>
        </div>
