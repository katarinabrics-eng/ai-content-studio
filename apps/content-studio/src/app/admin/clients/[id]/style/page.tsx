...
export default function AdminClientStylePage() {
  ...
  return (
    <div className="p-6 max-w-4xl">
      ...
      <h1 className="mt-4 text-2xl font-semibold text-[#F5F5F5]" style={{ fontFamily: "var(--font-admin-serif), serif" }}>
        Grafický styl · {project.name ?? project.email ?? "Klient"}
      </h1>
      <p className="mt-1 text-sm text-[#888]">AI doporučení + manuální výběr stylu.</p>
      <div className="mt-8 rounded-xl border border-white/[0.08] bg-[#1A1A1A] p-8 text-center" style={{ boxShadow: "0 0 40px rgba(201,169,110,0.05)" }}>
        <p className="text-[#888]">Sekce výběru grafického stylu bude doplněna podle CURSOR_PROMPT.</p>
